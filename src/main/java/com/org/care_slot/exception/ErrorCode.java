...
public enum ErrorCode {
    ...
    ROOM_NOT_FOUND(2007, "Room not found", HttpStatus.NOT_FOUND),
    DEPARTMENT_NOT_FOUND(2008, "Department not found", HttpStatus.NOT_FOUND),
    ...
    ROOM_TIME_OVERLAP(3007, "Phòng khám đã được lên lịch cho một ca khám khác trong cùng khung giờ", HttpStatus.CONFLICT),
